        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-xs text-cyan-400 hover:underline">Forgot password?</Link>
            </div>
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Don't have an account? <Link href="/auth/register" className="text-cyan-400 hover:underline">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
